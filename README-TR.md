...
- [İçindekiler](#i̇çindekiler)
  - [Hakkında ve Özellikler](#hakkında-ve-özellikler)
    - [Masaüstü](#masaüstü)
    - [Steam Deck/Ev Sinema sistemleri (HTPCs)](#steam-deckhome-theater-pcs-htpcs)
      - [Alternatif el konsolları](#alternative-handhelds)
    - [GNOME](#gnome)
    - [Üst kanaldan özellikler](#features-from-upstream)
      - [Universal Blue](#universal-blue)
      - [Fedora Linux'tan özellikler (Kinoite \& Silverblue)](#features-from-fedora-linux-kinoite--silverblue)
  - [Neden](#why)
  - [Vitrin](#showcase)
  - [Dokümantasyon](#documentation)
  - [Doğrulama](#verification)
  - [Secure Boot](#secure-boot)
  - [Katılımcı Ölçüleri](#contributor-metrics)
  - [Yıldız Geçmişi](#star-history)
  - [Özel Teşekkürler](#special-thanks)
  - [Kendinizinkini Yapın](#build-your-own)
  - [Topluluğa Katılın](#join-the-community)
---

## Hakkında ve Özellikler

[Lütfen web sitemize göz atın](https://bazzite.gg/) Bazzite yeni başlayanlar için kolay anlaşılır bir açıklama. bu readme herşeyi derinlemesine kapsayacak.
